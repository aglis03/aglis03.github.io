...
pre-pruning, limitations/boundaries -> limits complexity // post -> lets tree grow and justify -> post in this case

```{r}
#TRAIN/CONTROL DATA -> create hyperparamters to create parameters+models
